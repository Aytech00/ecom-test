...
// API
import { addProduct, getCategories, uploadFile } from "@/utils/api";
      ...
      <div className="w-full mx-auto">
        <div className="bg-white p-5 rounded-md w-full">
          ...
          <form className="mt-7" onSubmit={handleSubmit}>
            <div className="grid sm:grid-cols-1 gap-5 mb-5">
              <div>
                <Input
                  type="text"
                  ...
                  <DataTable value={variations} stripedRows>
                    <Column
                      ...
                      body={(variation) =>
                        variation.imagePath && (
                          <Image
                            src={`${process.env.NEXT_PUBLIC_API_URL}/${variation.imagePath}`}
                            alt=""
                            width={75}
                            height={75}
                          />
